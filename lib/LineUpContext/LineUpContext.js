...
var mapDispatchToProps = function (dispatch) { return ({
    setCurrentAggregation: function (samples) { return dispatch(selectVectors(samples)); },
    setLineUpInput_visibility: function (visibility) { return dispatch(setDetailVisibility(visibility)); },
