...
import { equal, createSelectionDesc, Column, ERenderMode, renderMissingDOM, StringColumn, } from "lineupjs";
...
export var LineUpContext = connector(function (_a) {
    ...
    React.useEffect(function () {
        ...
        // }
        var _a;
        var temp_data = preprocess_lineup_data(lineUpInput_data);
        var lineup_data = temp_data[0];
        var columns = temp_data[1];
        var builder = buildLineup(columns, lineup_data, pointColorScale, channelColor); //lineUpInput_data
        ...
        var selection_col = ranking.children.find(function (x) { return x.label == "Selection Checkboxes"; });
        if (!selection_col) {
        ...
        if (smiles_structure_columns.length > 0 ||
            ...
            var lineup_smiles_cols = ranking.children.filter(function (x) {
                ...
                var filterChanged = function (prev, cur) {
                    if ((prev === null || prev === void 0 ? void 0 : prev.filter) !== (cur === null || cur === void 0 ? void 0 : cur.filter)) {
                        ...
                        if (lineup_smiles_col && filter_1) {
                            CIMEBackendFromEnv.getSubstructureCount(lineUpInput_data.map(function (d) { return d[lineup_smiles_col.desc.column]; }), filter_1)
        ...
        (_b = activeStory === null || activeStory === void 0 ? void 0 : activeStory.clusters) === null || _b === void 0 ? void 0 : _b.allIds.length,
        lineUpInput.update,
    ]);
                ...
                var _loop_3 = function (key) {
                    ...
                    if (key === "reset" && cur_filter) {
                        ...
                        lineUpInput.filter[key].forEach(function (element) {
                            regex_str_1 += "|";
                            regex_str_1 += element["__meta__"]["meshIndex"];
                        });
                        regex_str_1 = regex_str_1.substr(1); // remove the leading "|"
                        var my_regex = new RegExp("^(" + regex_str_1 + ")$", "i"); // i modifier says that it's not case sensitive; ^ means start of string; $ means end of string
                        ...
                        var my_regex = new RegExp("^(.+,)?" + cur_filter + "(,.+)?$", "i"); // i modifier says that it's not case sensitive; ^ means start of string; $ means end of string
                        filter_col === null || filter_col === void 0 ? void 0 : filter_col.setFilter({
                            filter: my_regex,
                            filterMissing: true,
                        });
    ...
    return false ? (_jsx(MyWindowPortal, __assign({ onClose: function () {
            var _a;
            (_a = lineUpInput.lineup) === null || _a === void 0 ? void 0 : _a.destroy();
            setLineUpInput_visibility(false);
        } }, { children: _jsx("div", { ref: lineup_ref, id: "lineup_view" }, void 0) }), void 0)) : (_jsx("div", __assign({ className: "LineUpParent" }, { children: _jsx("div", { children: _jsx("div", { ref: lineup_ref, id: "lineup_view" }, void 0) }, void 0) }), void 0));
});
    ...
    MyLineChartRenderer.prototype.create = function (col) {
        return {
            ...
            update: function (n, d) {
                ...
                var data_max = d3.max(data_mean_list, function (d) {
                    return +d;
                }) + 1;
                // const data_min = col.getMin();
                var data_min = d3.min(data_mean_list, function (d) {
                    return +d;
                }) - 1;
                ...
                path.datum(data_mean_list).attr("d", d3
                    .line()
                    .x(function (d, i) {
                    return x(i);
                }) // i/data_list.length
