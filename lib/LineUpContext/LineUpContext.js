...
export var LineUpContext = connector(function (_a) {
    ...
    return false ? (_jsx(MyWindowPortal, __assign({ onClose: function () {
            ...
            setLineUpInput_visibility(false);
        } }, { children: _jsx("div", { ref: lineup_ref, id: "lineup_view" }, void 0) }), void 0)) : (_jsx("div", __assign({ className: "LineUpParent" }, { children: _jsx("div", { style: {
                clear: 'both',
                position: 'absolute',
                top: '1px',
                bottom: 0,
                ...
                right: 0,
                padding: 0
            }, ref: lineup_ref, id: "lineup_view" }, void 0) }), void 0));
});
