...
var SET_SHOW_BARCHART = 'ducks/rdkitsettings/SHOW_BARCHART';
var SET_SHOW_ATTRIBUTES = 'ducks/rdkitsettings/SHOW_ATTRIBUTES';
...
export var setRDKit_showBarChart = function (input) { return ({
    type: SET_SHOW_BARCHART,
    input: input,
}); };
export var setRDKit_showAttributes = function (input) { return ({
...
var rdkitSettings = function (state, action) {
    ...
    switch (action.type) {
        ...
        case SET_SHOW_BARCHART:
            return __assign(__assign({}, state), { showBarChart: action.input });
        case SET_SHOW_ATTRIBUTES:
            return __assign(__assign({}, state), { showAttributes: action.input });
        default:
            return state;
    }
};
