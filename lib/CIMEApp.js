...
export function CIMEApp(props) {
    ...
    return (merged ? _jsx(PSEContextProvider, __assign({ context: CIMEAppContext }, { children: _jsx("div", __assign({ style: { width: '100%', height: '100%' } }, { children: _jsx(Application, { config: merged.config, features: merged.features, 
                //@ts-ignore
