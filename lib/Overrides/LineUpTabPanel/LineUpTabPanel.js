...
import { setLineUpInput_filter, setLineUpInput_visibility, } from "../../State/LineUpInputDuck";
...
var mapDispatchToProps = function (dispatch) { return ({
    setLineUpInput_visibility: function (value) {
        return dispatch(setLineUpInput_visibility(value));
    },
...
export var LineUpTabPanel = connector(function (_a) {
    var setLineUpInput_visibility = _a.setLineUpInput_visibility, setLineUpInput_filter = _a.setLineUpInput_filter, lineUpInput = _a.lineUpInput, dataset = _a.dataset, currentAggregation = _a.currentAggregation, splitRef = _a.splitRef;
