...
var SettingsPopover = connector_settings(function (_a) {
    ...
    return (_jsx(Popover, __assign({ disablePortal: true, id: "dialog to open", open: open, anchorEl: anchorEl, onClose: function () { return setOpen(function () { return false; }); }, anchorOrigin: {
            ...
            vertical: "bottom",
            horizontal: "left",
        } }, { children: _jsx("div", { children: _jsx(Paper, __assign({ style: { padding: 10, minWidth: 300 } }, { children: _jsxs(Grid, __assign({ container: true, spacing: 2, direction: 'column', justifyContent: 'stretch', sx: {
                        '& .MuiTextField-root': { width: '200px' },
                    } }, { children: [_jsx(Grid, __assign({ item: true }, { children: _jsxs(Button, __assign({ size: "small", variant: "outlined", "aria-label": "Refresh Representation List", onClick: function () { return refreshRepList(true); } }, { children: [_jsx(RefreshIcon, {}, void 0), "Refresh Representation List"] }), void 0) }), void 0), _jsx(Grid, __assign({ item: true }, { children: _jsx(Typography, __assign({ variant: "subtitle2", gutterBottom: true }, { children: "RDKit Settings" }), void 0) }), void 0), _jsxs(Grid, __assign({ item: true, container: true, alignItems: 'center' }, { children: [_jsx(TextField, { label: "Contour Lines", type: "number", InputLabelProps: {
                                        shrink: true
                                    ...
                                    } }, void 0), _jsx("div", { style: { flexGrow: 1 } }, void 0), _jsx(Tooltip, __assign({ title: "Number of Contour Lines [0; \u221E] \u2208 \u2115" }, { children: _jsx(InfoIcon, { fontSize: "small" }, void 0) }), void 0)] }), void 0), _jsxs(Grid, __assign({ item: true, container: true, alignItems: 'center' }, { children: [_jsx(TextField, { label: "Scale", type: "number", InputLabelProps: {
                                        shrink: true
                                    ...
                                    } }, void 0), _jsx("div", { style: { flexGrow: 1 } }, void 0), _jsx(Tooltip, __assign({ title: "Weight Scale [-1; \u221E] \u2208 \u211D" }, { children: _jsx(InfoIcon, { fontSize: "small" }, void 0) }), void 0)] }), void 0), _jsxs(Grid, __assign({ item: true, container: true, alignItems: 'center' }, { children: [_jsx(TextField, { label: "Sigma", type: "number", InputLabelProps: {
                                        shrink: true
                                    }, inputProps: {
                                        step: 0.1
                                    ...
                                    } }, void 0), _jsx("div", { style: { flexGrow: 1 } }, void 0), _jsx(Tooltip, __assign({ title: "Sigma for Gaussian ]0; \u221E] \u2208 \u211D. Default of 0 signals the algorithm to infer the value." }, { children: _jsx(InfoIcon, { fontSize: "small" }, void 0) }), void 0)] }), void 0), _jsx(Grid, __assign({ item: true }, { children: _jsx(FormControlLabel, { control: _jsx(Switch, { color: "primary", checked: rdkitSettings.showMCS, onChange: function (_, value) {
                                        setShowMCS(value);
                                    } }, void 0), label: "Show MCS" }, void 0) }), void 0), _jsx(Grid, __assign({ item: true }, { children: _jsx(FormControlLabel, { control: _jsx(Switch, { color: "primary", checked: rdkitSettings.doAlignment, onChange: function (_, value) {
                                        setDoAlignment(value);
                                    } }, void 0), label: "Align Structure" }, void 0) }), void 0), _jsxs(Grid, __assign({ item: true }, { children: [_jsx(Typography, __assign({ style: { paddingTop: 10 }, gutterBottom: true }, { children: "Image Width" }), void 0), _jsx(Slider, { value: rdkitSettings.width, onChange: function (event, new_val) {
                                        setWidth(new_val);
                                    }, min: 50, max: 500, step: 10 }, void 0)] }), void 0), _jsx(Grid, __assign({ item: true }, { children: _jsx(Button, __assign({ style: { marginTop: 3, maxWidth: 150 }, size: "small", variant: "outlined", onClick: function () {
                                    setRefresh((rdkitSettings.refresh += 1));
                                } }, { children: "Apply Settings" }), void 0) }), void 0)] }), void 0) }), void 0) }, void 0) }), void 0));
});
