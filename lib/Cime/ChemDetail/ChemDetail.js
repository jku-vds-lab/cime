...
import "./chem.scss";
import { Autocomplete, Box, Button, Checkbox, createFilterOptions, FormControl, FormControlLabel, FormGroup, Grid, IconButton, Input, InputLabel, Paper, Popover, Switch, TextField, Tooltip, Typography, } from "@mui/material";
