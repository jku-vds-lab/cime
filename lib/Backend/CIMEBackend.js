...
var CIMEBackend = /** @class */ (function () {
    function CIMEBackend(baseUrl, fetchParams) {
        ...
        this.getRepresentationList = function (refresh, id, controller) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    path = this.baseUrl + "/get_atom_rep_list/".concat(id);
        ...
        this.calculateScores = function (id, cime_ids, currentRep) { return __awaiter(_this, void 0, void 0, function () {
            var formData, _i, cime_ids_1, value, _a, currentRep_1, value;
            return __generator(this, function (_b) {
                formData = new FormData();
                formData.append('filename', id);
                for (_i = 0, cime_ids_1 = cime_ids; _i < cime_ids_1.length; _i++) {
                    value = cime_ids_1[_i];
                    formData.append('ids', value);
                }
                for (_a = 0, currentRep_1 = currentRep; _a < currentRep_1.length; _a++) {
                    value = currentRep_1[_a];
                    formData.append('current_rep', value);
                }
                return [2 /*return*/, fetch(this.baseUrl + '/calculate_scores', {
                        method: 'POST',
                        body: formData,
                    })
                        .then(this.handleErrors)
...
export var CIMEBackendFromEnv = new CIMEBackend(process.env.REACT_APP_CIME_BACKEND_URL, {
    credentials: process.env.REACT_APP_CIME_BACKEND_CREDENTIALS || 'same-origin',
});
